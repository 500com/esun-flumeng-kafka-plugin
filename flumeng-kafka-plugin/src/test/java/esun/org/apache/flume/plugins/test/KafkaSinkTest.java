...
import esun.org.apache.flume.plugins.KafkaSinkForClickstream;
...
public class KafkaSinkTest {
    ...
    private KafkaSinkForClickstream sinkCli;
    /**
     * The Flume Context.
     */
    ...
    public void setUp() throws Exception {
        ...
        // create KafkaSinkForClickstream instance.
        /*sinkCli = new KafkaSinkForClickstream();
        sinkCli.setChannel(new MemoryChannel());
        Configurables.configure(sinkCli, this.context);*/
